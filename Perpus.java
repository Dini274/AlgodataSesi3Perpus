...
public class Perpus {
  public static void main(String[] args) {
    ...
    dataMahasiswa.add(new Mahasiswa("1", "Dini Aryani"));
    dataMahasiswa.add(new Mahasiswa("2", "Phina Putri"));
    dataMahasiswa.add(new Mahasiswa("3", "Helfi"));

    ArrayList <Buku> dataBuku = new ArrayList<>(); 

    dataBuku.add(new Buku("1", "C"));
    dataBuku.add(new Buku("2", "Java"));
    dataBuku.add(new Buku("3", "Pemograman"));

    ArrayList <Transaksi> dataTransaksi = new ArrayList<>(); 

    dataTransaksi.add(new Transaksi(
          dataMahasiswa.get(1).nim,
          dataMahasiswa.get(1).nama,
          dataBuku.get(1).judul,
            3
        ));
    ...
    while(keluar != 1) {
      ...
      System.out.print("\n");
      System.out.print("--------- Pilih Yang DiInginkan    -------------- \n");
